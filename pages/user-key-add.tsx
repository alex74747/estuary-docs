...
const curl = `curl -X POST https://api.estuary.tech/user/api-keys?expiry=EXPIRY&perms=PERMS -H "Authorization: Bearer REPLACE_ME_WITH_API_KEY" -H "Accept: application/json"`;
const code = null;
